...
namespace Fargowiltas
{
	class soulcheck : UIState
	{
		...
		public static UICheckbox inferno;
		...
		public static bool bees = true;
		public UICheckbox beesBox;
		
		//pets
		public static bool dinoPet = true;
		public UICheckbox dinoPetBox;
		public static bool penguinPet = true;
		public UICheckbox penguinPetBox;
		public static bool skullPet = true;
		public UICheckbox skullPetBox;
		public static bool turtlePet = true;
		public UICheckbox turtlePetBox;
		public static bool snowmanPet = true;
		public UICheckbox snowmanPetBox;
		public static bool fishPet = true;
		public UICheckbox fishPetBox;
		public static bool cubePet = true;
		public UICheckbox cubePetBox;
		public static bool grinchPet = true;
		public UICheckbox grinchPetBox;
		public static bool lizPet = true;
		public UICheckbox lizPetBox;
		public static bool suspiciousEyePet = true;
		public UICheckbox suspiciousEyePetBox;
		public static bool minotaurPet = true;
		public UICheckbox minotaurPetBox;
		public static bool eaterPet = true;
		public UICheckbox eaterPetBox;
		public static bool facePet = true;
		public UICheckbox facePetBox;
		public static bool spiderPet = true;
		public UICheckbox spiderPetBox;
		public static bool beePet = true;
		public UICheckbox beePetBox;
		public static bool wispPet = true;
		public UICheckbox wispPetBox;
		public static bool saplingPet = true;
		public UICheckbox saplingPetBox;
		public static bool catPet = true;
		public UICheckbox catPetBox;
		...
		public override void OnInitialize()
		{
			...
			checklistPanel.Width.Set(400f, 0f);
			...
			seasonalSpawnsBox = new UICheckbox("Seasonal Enemies", "",new Color(114, 74, 25), new Color(173, 94, 171), true, 1f, false);
			...
			beesBox = new UICheckbox("Bees on Hit", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			beesBox.Top.Set(550f, 0f);
			beesBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				bees = !bees;
			};
			checklistPanel.Append(beesBox);
			
			//column 2 boiii
			dinoPetBox = new UICheckbox("Baby Dino Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			dinoPetBox.Left.Set(200f, 0f);
			dinoPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				dinoPet = !dinoPet;
			};
			checklistPanel.Append(dinoPetBox);
			
			penguinPetBox = new UICheckbox("Baby Penguin Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			penguinPetBox.Left.Set(200f, 0f);
			penguinPetBox.Top.Set(25f, 0f);
			penguinPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				penguinPet = !penguinPet;
			};
			checklistPanel.Append(penguinPetBox);
			
			skullPetBox = new UICheckbox("Baby Skeletron Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			skullPetBox.Left.Set(200f, 0f);
			skullPetBox.Top.Set(50f, 0f);
			skullPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				skullPet = !skullPet;
			};
			checklistPanel.Append(skullPetBox);
			
			turtlePetBox = new UICheckbox("Turtle Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			turtlePetBox.Left.Set(200f, 0f);
			turtlePetBox.Top.Set(75f, 0f);
			turtlePetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				turtlePet = !turtlePet;
			};
			checklistPanel.Append(turtlePetBox);
			
			snowmanPetBox = new UICheckbox("Baby Snowman Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			snowmanPetBox.Left.Set(200f, 0f);
			snowmanPetBox.Top.Set(100f, 0f);
			snowmanPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				snowmanPet = !snowmanPet;
			};
			checklistPanel.Append(snowmanPetBox);
			
			fishPetBox = new UICheckbox("Zephyr Fish Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			fishPetBox.Left.Set(200f, 0f);
			fishPetBox.Top.Set(125f, 0f);
			fishPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				fishPet = !fishPet;
			};
			checklistPanel.Append(fishPetBox);
			
			cubePetBox = new UICheckbox("Companion Cube Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			cubePetBox.Left.Set(200f, 0f);
			cubePetBox.Top.Set(150f, 0f);
			cubePetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				cubePet = !cubePet;
			};
			checklistPanel.Append(cubePetBox);
			
			grinchPetBox = new UICheckbox("Baby Grinch Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			grinchPetBox.Left.Set(200f, 0f);
			grinchPetBox.Top.Set(175f, 0f);
			grinchPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				grinchPet = !grinchPet;
			};
			checklistPanel.Append(grinchPetBox);
			
			lizPetBox = new UICheckbox("Lizard Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			lizPetBox.Left.Set(200f, 0f);
			lizPetBox.Top.Set(200f, 0f);
			lizPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				lizPet = !lizPet;
			};
			checklistPanel.Append(lizPetBox);
			
			suspiciousEyePetBox = new UICheckbox("Suspicious Looking Eye Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			suspiciousEyePetBox.Left.Set(200f, 0f);
			suspiciousEyePetBox.Top.Set(225f, 0f);
			suspiciousEyePetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				suspiciousEyePet = !suspiciousEyePet;
			};
			checklistPanel.Append(suspiciousEyePetBox);
			
			minotaurPetBox = new UICheckbox("Mini Minotaur Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			minotaurPetBox.Left.Set(200f, 0f);
			minotaurPetBox.Top.Set(250f, 0f);
			minotaurPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				minotaurPet = !minotaurPet;
			};
			checklistPanel.Append(minotaurPetBox);
			
			eaterPetBox = new UICheckbox("Baby Eater Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			eaterPetBox.Left.Set(200f, 0f);
			eaterPetBox.Top.Set(275f, 0f);
			eaterPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				eaterPet = !eaterPet;
			};
			checklistPanel.Append(eaterPetBox);
			
			facePetBox = new UICheckbox("Baby Face Monster Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			facePetBox.Left.Set(200f, 0f);
			facePetBox.Top.Set(300f, 0f);
			facePetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				facePet = !facePet;
			};
			checklistPanel.Append(facePetBox);
			
			spiderPetBox = new UICheckbox("Spider Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			spiderPetBox.Left.Set(200f, 0f);
			spiderPetBox.Top.Set(325f, 0f);
			spiderPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				spiderPet = !spiderPet;
			};
			checklistPanel.Append(spiderPetBox);
			
			beePetBox = new UICheckbox("Baby Hornet Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			beePetBox.Left.Set(200f, 0f);
			beePetBox.Top.Set(350f, 0f);
			beePetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				beePet = !beePet;
			};
			checklistPanel.Append(beePetBox);
			
			wispPetBox = new UICheckbox("Wisp Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			wispPetBox.Left.Set(200f, 0f);
			wispPetBox.Top.Set(375f, 0f);
			wispPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				wispPet = !wispPet;
			};
			checklistPanel.Append(wispPetBox);
			
			saplingPetBox = new UICheckbox("Cursed Sapling Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			saplingPetBox.Left.Set(200f, 0f);
			saplingPetBox.Top.Set(400f, 0f);
			saplingPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				saplingPet = !saplingPet;
			};
			checklistPanel.Append(saplingPetBox);
			
			catPetBox = new UICheckbox("Black Cat Pet", "",new Color(81, 181, 113), new Color(173, 94, 171), true, 1f, false);
			catPetBox.Left.Set(200f, 0f);
			catPetBox.Top.Set(425f, 0f);
			catPetBox.OnSelectedChanged += (object o, EventArgs e) =>
			{
				catPet = !catPet;
			};
			checklistPanel.Append(catPetBox);
			//RIP PAGE SELECT
