	...
	public class PandorasBox : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Summons something at random\n" +
								"Different results depending on day or night\n" +
			...
			if(!Main.dayTime)
			{
				...
				switch(occur)
				{
					...
					case 36:						
						...
						/*string[] kinds = new string[] {"Blue Slime",
								"Green Slime",
								"Pinky",
								"Jungle Slime",
								"Red Slime",
						...
						{
							int newSlime = NPC.NewNPC((int) player.position.X + (start + change),(int) player.position.Y - 220, NPCID.BlueSlime);
							NPCID.[newSlime].SetDefaults(kind);
							change += 10;
						}*/
						break;
					case 37:
					...
					case 42:
						...
						break;
					case 43:
						NPC.NewNPC((int)player.position.X, (int)player.position.Y - 220, NPCID.SkeletonMerchant);
						break;
					default:
			...
			else
			{
				...
				switch(occur)
				{
					...
					case 4:
						...
						{
							NPC.NewNPC((int)player.position.X + Main.rand.Next(-150,150), (int)player.position.Y - 50, NPCID.TravellingMerchant);
							Main.NewText("Travelling Merchant has arrived!", 175, 75, 255);
						}
						else
						{
							NPC.NewNPC((int)player.position.X, (int)player.position.Y - 400, NPCID.DukeFishron);
					...
					case 6:
					case 7:
							NPC.NewNPC((int)player.position.X, (int)player.position.Y - 400, NPCID.SkeletronPrime);
							Main.NewText("Skeletron Prime has awoken!", 175, 75, 255);
						break;
					default:
							NPC.NewNPC((int)player.position.X, (int)player.position.Y - 400, NPCID.DungeonGuardian);
