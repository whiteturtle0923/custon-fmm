...
namespace Fargowiltas.Items.Summons.SwarmSummons.Thorium
{
    public class OverloadAbyssion : ModItem
    {
        ...
        public override bool UseItem(Player player)
        {
            ...
            if (Main.netMode == 2)
            {
                NetMessage.BroadcastChatMessage(NetworkText.FromLiteral("The Depths quake with rage!"), new Color(175, 75, 255));
            }
            else
            {
                Main.NewText("The Depths quake with rage!", 175, 75, 255);
            }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "AbyssionSummon");
