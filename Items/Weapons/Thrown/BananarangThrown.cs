...
namespace Fargowiltas.Items.Weapons.Thrown
{
    public class BananarangThrown : ModItem
    {
        ...
        public override string Texture => "Terraria/Item_1324";
        ...
        {
            int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, ItemID.Bananarang, 1, false, item.prefix);
