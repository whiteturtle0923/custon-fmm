...
namespace Fargowiltas.Items.Weapons.Thrown
{
    public class WoodenBoomerangThrown : ModItem
    {
        ...
        public override string Texture => "Terraria/Item_284";
        ...
        {
            int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, ItemID.WoodenBoomerang, 1, false, item.prefix);
