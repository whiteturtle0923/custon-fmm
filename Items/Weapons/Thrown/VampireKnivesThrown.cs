...
namespace Fargowiltas.Items.Weapons.Thrown
{
    public class VampireKnivesThrown : ModItem
    {
        ...
        public override string Texture => "Terraria/Item_1569";
        ...
        {
            int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, ItemID.VampireKnives, 1, false, item.prefix);
