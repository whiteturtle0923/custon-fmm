...
namespace Fargowiltas.Items.Weapons.Thrown
{
    public class LightDiscThrown : ModItem
    {
        ...
        public override string Texture => "Terraria/Item_561";
        ...
        {
            int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, ItemID.LightDisc, 1, false, item.prefix);
