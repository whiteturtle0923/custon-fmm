...
namespace Fargowiltas.Items.Weapons.Thrown
{
    public class ToxicFlaskThrown : ModItem
    {
        ...
        public override string Texture => "Terraria/Item_3105";
        ...
        {
            int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, ItemID.ToxicFlask, 1, false, item.prefix);
