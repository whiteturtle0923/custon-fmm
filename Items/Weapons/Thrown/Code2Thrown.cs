...
namespace Fargowiltas.Items.Weapons.Thrown
{
    public class Code2Thrown : ModItem
    {
        ...
        public override string Texture => "Terraria/Item_3284";
        ...
        {
            int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, ItemID.Code2, 1, false, item.prefix);
