...
namespace Fargowiltas.Items.Weapons.Thrown
{
    public class FormatCThrown : ModItem
    {
        ...
        public override string Texture => "Terraria/Item_3315";
        ...
        {
            int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, ItemID.FormatC, 1, false, item.prefix);
