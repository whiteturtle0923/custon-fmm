...
namespace Fargowiltas.Items.Weapons.Thrown
{
    public class BlueMoonThrown : ModItem
    {
        ...
        public override string Texture => "Terraria/Item_163";
        ...
        {
            int num = Item.NewItem((int)player.position.X, (int)player.position.Y, player.width, player.height, ItemID.BlueMoon, 1, false, item.prefix);
