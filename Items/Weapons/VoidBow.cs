...
namespace Fargowiltas.Items.Weapons
{
    public class VoidBow : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddRecipeGroup("Fargowiltas:AnyCobaltRepeater");
            recipe.AddRecipeGroup("Fargowiltas:AnyMythrilRepeater");
            recipe.AddRecipeGroup("Fargowiltas:AnyAdamantiteRepeater");
