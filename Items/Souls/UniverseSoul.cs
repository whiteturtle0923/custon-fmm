...
namespace Fargowiltas.Items.Souls
{
	public class UniverseSoul : ModItem
	{
		...
		public override void AddRecipes()
		{
			...
			if(Fargowiltas.instance.calamityLoaded)
			{
				recipe.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("ArkoftheCosmos"));
				recipe.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("DragonsBreath"));				
				recipe.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("TheWand"));
				recipe.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("AngryChickenStaff"));
				recipe.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("ProfanedTrident"));
