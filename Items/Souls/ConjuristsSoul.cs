		...
		public override void AddRecipes()
        {
			...
			if(Fargowiltas.instance.thoriumLoaded)
			{
				if(Fargowiltas.instance.calamityLoaded)
				{
					...
					if(!Fargowiltas.instance.blueMagicLoaded)
					{
						...
						summon2.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("ElementalAxe"));	
						summon2.AddIngredient(ItemID.MoonlordTurretStaff);
						summon2.AddIngredient(ModLoader.GetMod("ThoriumMod").ItemType("HellbringerStaff"));	
			...
			if(!Fargowiltas.instance.thoriumLoaded)
			{
				...
				if(Fargowiltas.instance.calamityLoaded)
				{
					...
					{
						//just calamity
						summon2.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("SunGodStaff"));	
					}
